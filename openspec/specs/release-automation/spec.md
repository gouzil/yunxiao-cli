...
## Purpose
Define the tag-triggered GitHub Release workflow, GoReleaser build metadata, cross-platform artifacts, and release documentation requirements for Yunxiao CLI.
## Requirements
